...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    ap.add_argument("--save-dir", type=str, default=None, help="If set, save student model/tokenizer to this directory at the end")
    ...
    if args.save_dir:
        ...
        print("Saving student to", str(out_dir))
        try:
